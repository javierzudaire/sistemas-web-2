 ...
 */
public class UpdateProducto2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                api.updateProducto(request.getParameter("EAN"), request.getParameter("opcion"), request.getParameter("valor"));
            } catch (Exception e) {
            ...
            out.println("<h3>Producto actualizado</h3>");
