    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                x.setEan(request.getParameter("EAN"));
                x.setNombre(request.getParameter("nombre"));
                x.setDescripcion(request.getParameter("descripcion"));
                x.setPrecio(Double.parseDouble(request.getParameter("precio")));
                tienda.setProducto(x);

            } catch (Exception e) {
                response.sendRedirect("AddProducto.html");
            }
